...
public class ResultController {
    ...
    @GetMapping(QUIZ + ID_PARAM)
    public QuizResultPage getQuizResultPage(@PathVariable(name = "id") Long quizId, @RequestParam Integer pageSize, @RequestParam Integer pageNumber) {
        return resultService.getQuizResults(quizId, pageSize, pageNumber);
    }
}
